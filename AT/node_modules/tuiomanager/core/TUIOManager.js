...
class TUIOManager {
  ...
  start(socketIOUrl = 'http://localhost:9000/') {
    ...
    // const socketIOClient2 = io('http://localhost:8000/');
    // this.socketIOClient2.on('connect', (data) => {
    //   this.socketIOClient2.emit('hello', 'connection with new server established');  
    // });
    // this.socketIOClient2.on('update', (data) => {
    //   this.socketIOClient2.emit('updating', 'updating phone public/private data');  
    // });
  }
