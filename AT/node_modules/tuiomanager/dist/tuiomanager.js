...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TUIOManager = __webpack_require__(1);

	var _TUIOManager2 = _interopRequireDefault(_TUIOManager);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var tuioManager = new _TUIOManager2.default(); /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TUIOTouch = __webpack_require__(48);

	var _TUIOTouch2 = _interopRequireDefault(_TUIOTouch);

	var _TUIOTag = __webpack_require__(50);

	var _TUIOTag2 = _interopRequireDefault(_TUIOTag);
	...
	var TUIOManager = function () {
	  ...
	  _createClass(TUIOManager, [{
	    ...
	    value: function start() {
	      ...
	      var socketIOClient = (0, _socket2.default)(socketIOUrl);
	      socketIOClient.on(_constants.CREATE_SOCKETIO_ACTION, function (data) {
	        _this.handleCreate(data);
	      });
	      socketIOClient.on(_constants.UPDATE_SOCKETIO_ACTION, function (data) {
	        _this.handleUpdate(data);
	      });
	      socketIOClient.on(_constants.DELETE_SOCKETIO_ACTION, function (data) {
	    ...
	    value: function handleCreate(socketData) {
	      switch (socketData.type) {
	        case _constants.TOUCH_SOCKETIO_TYPE:
	          {
	            this._touches[socketData.id] = new _TUIOTouch2.default(socketData.id, socketData.x, socketData.y);
	            console.log('add touch :', this._touches[socketData.id]);
	            break;
	          }
	        case _constants.TAG_SOCKETIO_TYPE:
	          {
	            this._tags[socketData.id] = new _TUIOTag2.default(socketData.id, socketData.tagId, socketData.x, socketData.y, socketData.angle);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (typeof window === 'undefined') {
	  try {
	    NodeWebSocket = __webpack_require__(40);
	  } catch (e) { }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TUIOObject2 = __webpack_require__(49);

	var _TUIOObject3 = _interopRequireDefault(_TUIOObject2);
	 ...
	 * @extends TUIOObject
	 */
	var TUIOTouch = function (_TUIOObject) {
	  _inherits(TUIOTouch, _TUIOObject);

	  function TUIOTouch() {
	    _classCallCheck(this, TUIOTouch);

	    return _possibleConstructorReturn(this, (TUIOTouch.__proto__ || Object.getPrototypeOf(TUIOTouch)).apply(this, arguments));
	  }

	  return TUIOTouch;
	}(_TUIOObject3.default);

	exports.default = TUIOTouch;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @extends TUIOObject
	 */
	var TUIOTag = function (_TUIOObject) {
	   ...
	   */
	  function TUIOTag(id, tagId, x, y, angle) {
	    _classCallCheck(this, TUIOTag);

	    var _this = _possibleConstructorReturn(this, (TUIOTag.__proto__ || Object.getPrototypeOf(TUIOTag)).call(this, id, x, y));
...
/***/ function(module, exports) {
	...
	var CREATE_SOCKETIO_ACTION = exports.CREATE_SOCKETIO_ACTION = 'CREATE';
	var UPDATE_SOCKETIO_ACTION = exports.UPDATE_SOCKETIO_ACTION = 'UPDATE';
	var DELETE_SOCKETIO_ACTION = exports.DELETE_SOCKETIO_ACTION = 'DELETE';

	/* SOCKET.IO message Types */
	var TOUCH_SOCKETIO_TYPE = exports.TOUCH_SOCKETIO_TYPE = 'TOUCH';
	var TAG_SOCKETIO_TYPE = exports.TAG_SOCKETIO_TYPE = 'TAG';
